...
class DesignersControllerTest < ActionController::TestCase
  ...
  test "should create designer" do
    assert_difference('Designer.count') do
      post :create, designer: { degn_id: @designer.degn_id, name: @designer.name, spell: @designer.spell, template: @designer.template }
    end
  ...
  test "should update designer" do
    patch :update, id: @designer, designer: { degn_id: @designer.degn_id, name: @designer.name, spell: @designer.spell, template: @designer.template }
    assert_redirected_to designer_path(assigns(:designer))
  end
